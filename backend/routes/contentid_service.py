    ...
    try:
        ...
        for index, creator in enumerate(creators):
            ...
            doc = {"id": doc_id, "ticket_id": ticket_id, "label_id": label["id"], "sequence": index + 1,
                   ...
                   "upc": str(release.get("upc") or ""), "tracks": [track for track in tracks if track["id"] in creator.track_ids],
                   ...
                   "pdf_key": key, "status": "ready", "consent_by": user["id"], "consent_at": issued_at, "template_version": 1}
