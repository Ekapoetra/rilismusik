...
export const BankChangePanel = ({ labelId, bank, canFinance, onChanged }) => {
  ...
  const [form, setForm] = useState({ bank_name: "", bank_value: "", account_number: "", account_holder_name: "", reason: "" });
  ...
  const begin = () => { setForm({ bank_name: bank.bank_name || "", bank_value: bank.bank_value || findBank(bank.bank_name)?.value || "", account_number: bank.account_number || "", account_holder_name: bank.account_holder_name || "", reason: "" }); setEditing(true); };
