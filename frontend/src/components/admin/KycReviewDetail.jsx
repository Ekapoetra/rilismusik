...
export const KycReviewDetail = ({ detail, onReviewed }) => {
  ...
  const review = async (action) => {
    ...
    try {
      ...
      toast.success(action === "approve" ? "KYC label disetujui." : "Pengajuan KYC ditolak.");
