...
export const AdminSidebarView = ({ instance, collapsed, onCollapse, onNavigate, items, user, logout, preview = false }) => {
  ...
  return <div className="dashboard-sidebar relative flex h-full flex-col" data-testid={`admin-sidebar-${instance}`}>
    ...
    <nav className="min-h-0 flex-1 overflow-y-auto px-2 py-4" data-testid={`admin-navigation-${instance}`}>{roots.map((item) => {
