...
export default function UploadRelease() {
  ...
  const submit = async () => {
    if (quotaState.blocked) { setError("Kuota harian 7 rilisan telah habis. Kuota tersedia kembali pukul 00.00 WIB."); return; }
  ...
  return <div className="max-w-6xl space-y-7 pb-20">
    ...
    <SubmissionQuotaView state={quotaState} prefix="upload-release" />
