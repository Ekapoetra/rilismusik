    ...
    <div className="space-y-5 max-w-5xl">
      ...
      <div className="rm-card overflow-hidden">
        {items.length === 0 ? (
          ...
          <div key={i.id} className="px-5 py-4 border-b border-white/5 last:border-0 flex items-center justify-between gap-3 flex-wrap">
            <div className="flex items-center gap-3 min-w-0">
              <div className="w-10 h-10 rounded-xl bg-white/[0.06] text-zinc-400 grid place-items-center"><CreditCard className="w-4 h-4" /></div>
