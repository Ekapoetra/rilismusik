  ...
  return (
    <div className="min-h-screen rm-mesh flex items-center justify-center px-4 py-12 text-white">
      <div className="w-full max-w-md rm-glass-strong rounded-[28px] p-8 rm-fade-up">
        ...
        {done ? (
          <div className="mt-6 text-emerald-300 bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 text-sm" data-testid="reset-password-success">Password berhasil direset. Semua sesi lama telah dikeluarkan. Mengalihkan ke login…</div>
        ) : (
          <form onSubmit={submit} className="mt-6 space-y-4">
            ...
            {err && <div role="alert" className="text-sm text-red-300 bg-red-500/10 border border-red-500/20 rounded-xl px-3 py-2" data-testid="reset-password-error">{err}</div>}
