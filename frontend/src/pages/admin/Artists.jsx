  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rm-card overflow-hidden">
        ...
        {items.length === 0 ? <div className="p-8 text-center text-zinc-500 text-sm">Belum ada artist.</div> : items.map((a) => (
          <div key={a.id} className="px-5 py-4 grid grid-cols-12 gap-3 items-center border-b border-white/5 last:border-0">
