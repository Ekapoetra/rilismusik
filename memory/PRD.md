...
- Saldo pada daftar label dihitung bulk dari `royalty_lines` dengan aturan identik ke detail/withdrawable; nilai tersimpan lama hanya menjadi audit metadata dan tidak ditampilkan.
